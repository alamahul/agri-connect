...
const profilStats = [
  { label: 'Total Produk', value: '48', icon: Sprout, color: 'bg-emerald-100 text-emerald-600' },
  { label: 'Pesanan Selesai', value: '130', icon: ShoppingBag, color: 'bg-blue-100 text-blue-600' },
  { label: 'Pendapatan', value: 'Rp 45 Jt', icon: TrendingUp, color: 'bg-amber-100 text-amber-600' },
  { label: 'Rating Toko', value: '4.8 ★', icon: Award, color: 'bg-violet-100 text-violet-600' },
];
...
const ProfilPetani = () => {
  ...
  const [form, setForm] = useState({
    ...
    email: 'petani@agriconnect.id',
    phone: '+62 812-3456-7890',
    lokasi: 'Kab. Malang, Jawa Timur',
    lahan: '5.2 Hektar',
    bergabung: 'Maret 2024',
    bio: 'Petani aktif dengan pengalaman lebih dari 15 tahun di bidang pertanian padi dan sayuran organik.',
  });
  ...
  return (
    <div className="space-y-4 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 mt-0.5">Kelola informasi akun dan profil petani Anda</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-[6px] border border-slate-100 shadow-sm p-6 flex flex-col items-center text-center">
          ...
          <p className="text-xs text-slate-500 mt-0.5">Pemilik Lahan — Petani Aktif</p>
        ...
        <div className="lg:col-span-2 bg-white rounded-[6px] border border-slate-100 shadow-sm p-5">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {/* Phone */}
              <div>
                <label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider block mb-1.5">No. Telepon</label>
                {editMode ? (
              ...
              {/* Lokasi */}
              <div>
                <label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider block mb-1.5">Lokasi</label>
                {editMode ? (
              ...
              {/* Lahan */}
              <div>
                <label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider block mb-1.5">Luas Lahan</label>
                {editMode ? (
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center gap-2 text-xs text-slate-400">
              <Calendar size={13} />
              Bergabung sejak {form.bergabung}
            </div>
          </div>
        </div>
      </div>
