...
const CustomerSettings = () => {
  ...
  const tabs = [
    ...
    { id: 'payment', label: 'Rekening & Pembayaran', icon: <Wallet size={18} /> },
    ...
    <div className="space-y-8 pb-20 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-2 rounded-[2.5rem] border border-gray-100 shadow-sm sticky top-4">
             {tabs.map(tab => (
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id)}
                  className={`
                    w-full flex items-center gap-4 px-6 py-4 rounded-3xl transition-all duration-300 font-bold text-sm
                    ${activeTab === tab.id 
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-[3rem] border border-gray-100 shadow-sm p-8 md:p-12 min-h-[600px] relative overflow-hidden">
               ...
               <div className="space-y-8 animate-in slide-in-from-bottom-5 duration-500">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                     {[
                       ...
                       <div key={addr.id} className={`p-8 rounded-[2rem] border-2 transition-all group ${addr.isDefault ? 'border-amber-400 bg-amber-50/30 shadow-xl shadow-amber-50' : 'border-gray-100'}`}>
             ...
             {activeTab === 'payment' && (
               <div className="space-y-10 animate-in slide-in-from-bottom-5 duration-500">
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="p-8 rounded-[2.5rem] border-2 border-dashed border-gray-100 flex flex-col items-center justify-center text-center space-y-4 group hover:border-amber-400 transition-colors cursor-pointer" onClick={() => setShowSecurityModal(true)}>
      ...
      {showMapModal && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-2xl relative z-10 p-10 animate-in zoom-in-95 duration-500 overflow-hidden">
             <div className="mb-8">
      ...
      {showSecurityModal && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-[2.5rem] p-10 w-full max-w-md relative z-10 shadow-2xl animate-in zoom-in-95 duration-500 text-center">
