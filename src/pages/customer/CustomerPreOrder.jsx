  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
        {filteredData.length > 0 ? (
          filteredData.map((item) => (
            <div key={item.id} className="group bg-white rounded-[6px] border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden flex flex-col md:flex-row">
              {/* Image Section */}
      ...
      <section className="mt-12">
        <div className="bg-amber-50/50 rounded-[6px] border-2 border-dashed border-amber-200 p-8 flex flex-col md:flex-row items-center justify-between gap-6 group hover:border-amber-400 transition-colors transition-all">
