    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="space-y-5">
        {filteredOrders.length === 0 ? (
          ...
          <div key={order.orderId} className="group bg-white rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
            {/* Header Card */}
